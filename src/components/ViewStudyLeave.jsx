...
const ViewStudyLeave = () => {
  ...
  useEffect(() => {
    const fetchMessage = () => {
      if (isInbox && inboxData && inboxData.study_leaves) {
        const message = inboxData.study_leaves.find(
          (item) => item.id === pathId
        );
        setCurrentMessage(message);
      } else if (!isInbox && outboxData && outboxData.study_leaves) {
        const message = outboxData.study_leaves.find(
          (item) => item.id === pathId
        );
        setCurrentMessage(message);
      }
